...
public interface ISearchService extends ISetLocalManager, ISetRemoteManager {
	...
	Map<String, Long> searchSeriesLocal(String pattern) throws NoSeriesStoredException, NoKeywordsOnRemoteSearchException;
	
	Map<String, Long> searchSeriesRemote(String pattern) throws NoKeywordsOnRemoteSearchException;
