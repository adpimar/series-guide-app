...
public class SQLParser {
	...
	public static String insertSerieSQL(Serie serie) {
		...
		sb.append("INSERT INTO seriesguideapp.SERIES (cod_serie, series_name, status, first_aired, airs_dow, airs_time, network, genres, site_rating, site_rating_count, overview) VALUES (");
	...
	public static String insertSeasonSQL(Season season) {
		StringBuilder sb = new StringBuilder();	
		sb.append("INSERT INTO seriesguideapp.TEMPORADAS (cod_serie, cod_season, aired_season, first_aired, total_episodes, seen) VALUES (");
	...
	public static String insertEpisodeSQL(Episode episode) {
		StringBuilder sb = new StringBuilder();	
		sb.append("INSERT INTO seriesguideapp.EPISODIOS (cod_episode, cod_season, aired_season, aired_episode, episode_name, first_aired, overview, seen, comment) VALUES (");
	...
	public static String listSeriesSQL() {
		return "SELECT * FROM seriesguideapp.SERIES";
	}
	
	public static String listSeasonsSQL() {
		return "SELECT * FROM seriesguideapp.TEMPORADAS";
	}
	
	public static String listEpisodesSQL() {
		return "SELECT * FROM seriesguideapp.EPISODIOS";
	}
	...
	public static String updateSerieSQL(Serie serie) {
		StringBuilder sb = new StringBuilder();	
		sb.append("UPDATE seriesguideapp.SERIES SET ");
	...
	public static String updateSeasonSQL(Season season) {
		StringBuilder sb = new StringBuilder();			
		sb.append("UPDATE seriesguideapp.TEMPORADAS SET ");
	...
	public static String updateEpisodeSQL(Episode episode) {
		StringBuilder sb = new StringBuilder();	
		sb.append("UPDATE seriesguideapp.EPISODIOS SET ");
	...
	public static String getSerieSQL(long codSerie) {
		return "SELECT * FROM seriesguideapp.SERIES WHERE cod_serie = " + codSerie;
	}
	
	public static String getSeasonSQL(long codSeason) {
		return "SELECT * FROM seriesguideapp.TEMPORADAS WHERE cod_season = " + codSeason;
	}
	
	public static String getEpisodeSQL(long codEpisode) {
		return "SELECT * FROM seriesguideapp.EPISODIOS WHERE cod_episode = " + codEpisode;
	}
	
	// ------------------------------------------------------------------------
	
	public static String deleteSerieSQL(long codSerie) {
		return "DELETE FROM seriesguideapp.SERIES WHERE cod_serie = " + codSerie;
	}
	
	public static String deleteSeasonSQL(long codSeason) {
		return "DELETE FROM seriesguideapp.TEMPORADAS WHERE cod_season = " + codSeason;
	}
	
	public static String deleteEpisodeSQL(long codEpisode) {
		return "DELETE FROM seriesguideapp.EPISODIOS WHERE cod_episode = " + codEpisode;
	}
	
	// ------------------------------------------------------------------------
	
	public static String listSerieSeasonsSQL(long codSerie) {
		return "SELECT * FROM seriesguideapp.TEMPORADAS WHERE cod_serie = " + codSerie;
	}
	
	public static String listSeasonEpisodesSQL(long codSeason) {
		return "SELECT * FROM seriesguideapp.EPISODIOS WHERE cod_season = " + codSeason;
	}
