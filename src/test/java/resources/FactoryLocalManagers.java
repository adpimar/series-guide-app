...
public enum FactoryLocalManagers {
	...
	R13_1_1_2("R13.1.1.2.txt"),
	R13_1_2_1("R13.1.2.1.txt"),
	R13_1_3_1("R13.1.3.1.txt"),
	R13_1_3_2("R13.1.3.2.txt"),
	...
	R14_1_2_1("R14.1.2.1.txt"),
	R14_1_2_2("R14.1.2.2.txt"),
	R14_1_2_3("R14.1.2.3.txt"),
	R14_1_3_1("R14.1.3.1.txt"),
	R14_1_4_1("R14.1.4.1.txt"),
	R14_1_4_2("R14.1.4.2.txt"),
	R14_2_1_1("R14.2.1.1.txt"),
	R14_2_2_1("R14.2.2.1.txt"),
	R14_2_2_2("R14.2.2.2.txt"),
	R14_2_3_1("R14.2.3.1.txt"),
	...
	private FactoryLocalManagers(final String filename) {
	...
	public ILocalManager getLocalManager() {
		return new RealBDL(PATH + filename);
	}
